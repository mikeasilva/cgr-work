...
path <- 'H:/Data Warehouse/US Department of Housing and Urban Development (HUD)/USPS Vacancy Data/2010 Census Tracts'

## Get the list of files in the working directory
initial.files <- list.files(getwd())

## Get the list of zip files
zip.files <- list.files(path, pattern='_03')
